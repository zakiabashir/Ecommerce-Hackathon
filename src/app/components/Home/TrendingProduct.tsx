  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {products.map((product) => (
        <div
          key={product.id}
          className="w-full max-w-[270px] h-[360px] bg-white rounded-lg shadow-lg overflow-hidden group mx-auto relative transition-transform duration-300 transform hover:scale-105"
        >
          {/* Image Section */}
