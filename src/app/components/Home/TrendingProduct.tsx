          ...
          >
            ...
            <div className="relative flex justify-center">
              <Link href={`/trendingProduct/${product.id}`}>
                <button
                  className="absolute bottom-0 left-1/2 transform -translate-x-1/2 bg-[#15c662] hover:bg-purple-700 hover:text-white mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 px-2 py-1 rounded"
                >
                  View Details
                </button>
              </Link>
