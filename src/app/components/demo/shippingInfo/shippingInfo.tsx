    ...
    <div>
      <div className="md:mt-20 mt-8 max-w-[1400px] mx-auto px-4 md:px-8 lg:ml-16">
        ...
        <nav className="flex flex-wrap items-center space-x-1 text-base text-gray-500">
          <Link href="/pages/cart" className="hover:text-gray-900 text-[#151875] font-semibold">
            Cart
          </Link>
          <span>/</span>
          <Link href="/pages/information" className="hover:text-gray-900 text-[#151875] font-semibold">
            Information
          </Link>
          <span>/</span>
          <Link href="/pages/shippingInfo" className="hover:text-gray-900 text-[#151875] font-semibold">
            Shipping
          </Link>
          <span>/</span>
      ...
      <div className='mt-11 p-4 pb-16 bg-[#F6F5FF] py-11 lg:ml-20 mr-9'>
        ...
        <h6 className='text-[14px] text-gray-400 mb-2 mt-6 md:mt-9'>
        ...
        <div className='flex items-center gap-2 mt-4 md:mt-8'>
          <input
            ...
            type='checkbox'
          />
          <h6 className='text-gray-400 text-[12px]'>
        ...
        <div className='md:mt-28 mt-12'>
          <h3 className='text-[#151875] text-lg md:text-xl font-semibold mb-6'>
            Shipping Address
          </h3>
          <div>
            {/* First and Last Name */}
            <div className='flex flex-col md:flex-row justify-between gap-6'>
              ...
              <div>
                <h6 className='text-gray-400 mb-2'>Last name</h6>
                <div className='border-[1px] w-full md:w-[336px]'></div>
              </div>
            </div>
            ...
            {/* City */}
            <div className='mt-6'>
              <h6 className='text-gray-400 mb-2'>City</h6>
              <div className='border-[1px]'></div>
            </div>
            ...
            <div className='flex flex-col md:flex-row justify-between gap-6 mt-6'>
              <div>
                <h6 className='text-gray-400 mb-2'>Country</h6>
                <div className='border-[1px] w-full md:w-[336px]'></div>
              </div>
              <div>
                <h6 className='text-gray-400 mb-2'>Postal Code</h6>
                <div className='border-[1px] w-full md:w-[336px]'></div>
              </div>
            </div>
