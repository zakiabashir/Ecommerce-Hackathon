...
export default function Footer() {
  return (
    <footer className="w-full bg-[#eeeef1] p-4 md:p-8 lg:p-12">
    <div className="container mx-auto max-w-[1300px]">
      ...
      {/* Bottom Bar */}
      <div className="mt-11">
        <div className="bg-[#e0dfe2] flex flex-col items-center justify-evenly gap-6 lg:gap-56 border-t p-7  md:flex-row">
