...
// const [hoverStyle, setHoverStyle] = useState({ backgroundPosition: "center" });
  ...
  export default function NavigationLinksForDynamicPages() {
    ...
    return (
    <>
    <div className="max-w-[1800px] mx-auto mt-16 p-3 bg-[#F9F8FE]">
...
{activeLink === "video" && (
  <div ref={btn4Ref}>
    ...
    <p className="mt-4 text-[18px] py-2 text-[#5155e2]">
  ...
  >
    ...
    <h1 className="text-3xl mt-16 font-bold text-[#151875] mb-7 py-3 max-w-[1100px] mx-auto">Related Product</h1>
  <RelatedProducts/>
